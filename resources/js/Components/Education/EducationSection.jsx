                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white border-none rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 w-full md:w-64"
                        />
